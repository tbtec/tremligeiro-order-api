...
build-docker:
	docker build -t tbtec/tremligeiro-order:1.0.0 .	

run-docker:
	docker run -p 8080:8080 tbtec/tremligeiro-order:1.0.0 --env-file .env
...
docker-push:
	docker push tbtec/tremligeiro-order:1.0.0
